...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The code did not handle decreasing the number of turns and readding people at the back of the queue.
    ...
    // Defect(s) Found: The code didn't implement adding a new person to the FIFO order 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Infinite turn wasn't properly implemented
    ...
    // Defect(s) Found: Negative turns werent handled as infinite.
